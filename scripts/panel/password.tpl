                            ...
                            <form action="{route key='panelPassword'}" method="post">
                                <fieldset>
                                    ...
                                    <div class="shaded_inputwrap{if $data_error.pass} error{/if}">
                                        <input type="password" name="pass" id="pass_input" value="" size="30" {if $data_error.pass}aria-invalid="true" aria-describedby="error_pass"{/if} aria-required="true" />
                                    </div>
                                    {if $data_error.pass}
                                        <ul class="input_error error" id="error_pass">
                                    ...
                                    <div class="shaded_inputwrap{if $data_error.pass1} error{/if}">
                                        <input type="password" name="pass1" id="pass1_input" value="" size="30" {if $data_error.pass1}aria-invalid="true" aria-describedby="error_pass1"{/if} aria-required="true" />
                                    </div>
                                    {if $data_error.pass1}
                                        <ul class="input_error error" id="error_pass1">
                                    ...
                                    <div class="shaded_inputwrap{if $data_error.pass2} error{/if}">
                                        <input type="password" name="pass2" id="pass2_input" value="" size="30" {if $data_error.pass2}aria-invalid="true" aria-describedby="error_pass2"{/if} aria-required="true" />
                                    </div>
                                    {if $data_error.pass2}
                                        <ul class="input_error error" id="error_pass2">
