                        ...
                        <div class="innerbox">
                                ...
                                <table class="orders payable table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="parcels">{translate key='Shipment'}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                        ...
                                                        {if $onlinepayment->isPaymentFromPanelAllowed()}
                                                            {if !$onlinepayment->isFinished() or !$onlinepayment->isStarted()}
                                                                {if !$onlinepayment->isFinished() and $onlinepayment->isStarted()}
                                                                    <a class="titlequestion js__payment-link" title="{translate key='Your payment is currently being processed. Are you sure you want to pay again?'}" href="{route
                                                                        key='panelPayment' orderId=$id}">{translate key='pay again'}</a>
                                                                {else}
                                                                    <a class="js__payment-link" href="{route key='panelPayment' orderId=$id}">{translate key='pay'}</a>
                                                                {/if}
                                                            {/if}
                                                        {/if}
                                                    {else}
                            ...
                            {if count($user->user->exchangedProducts)}
                                ...
                                <table class="orders exchanged classic table">
                                    <thead>
                                        <tr>
                                            <th class="prod">{translate key='Product'}</th>
                                            <th class="quantity">{translate key='Quantity'}</th>
                                            <th class="points">{translate key='Points'}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
