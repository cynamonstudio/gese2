                    ...
                    <div class="box unibox" id="box_basketsummary">
                        <div class="innerbox">
                                ...
                                <div class="clear overflow">
                                    <div class="address delivery">
                                        ...
                                        {/if}
                                            ...
                                            <p>
                                                {if $data.mode == 'single'}
                                                    <a href="{route key='basketNoRegister'}">({translate key="Change shipping address" fallback="change"})</a>
                                                {elseif $data.mode == 'register'}
                                                    <a href="{route key='basketRegister'}">({translate key="Change shipping address" fallback="change"})</a>
                                                {else}
                                                    <a href="{route key='basketStep2'}">({translate key="Change shipping address" fallback="change"})</a>
                                                {/if}
                                            </p>
                                        </div>
                                    ...
                                    <div class="address invoice">
                                        ...
                                        <p>
                                            {if $data.mode == 'single'}
                                                <a href="{route key='basketNoRegister'}">({translate key="Change billing address" fallback="change"})</a>
                                            {elseif $data.mode == 'register'}
                                                <a href="{route key='basketRegister'}">({translate key="Change billing address" fallback="change"})</a>
                                            {else}
                                                <a href="{route key='basketStep2'}">({translate key="Change billing address" fallback="change"})</a>
                                            {/if}
                                        </p>
                                    </div>
                                        ...
                                        <ul>
                                            ...
                                            <li class="delivery">
                                                <span>
                                                    ...
                                                    <strong class="delivery">{$shipping->translation->name|escape}</strong>
                                                    <a href="{if $shipping_extra_step == 1}{route key='basketStep3'}{else}{route key='basket'}{/if}">({translate key="Change shipping method" fallback="change"})</a>
                                                </span>
                                            </li>
                                            ...
                                            <li class="payment">
                                                <span>
                                                    ...
                                                    <strong class="payment">{$payment->handler->getName()|escape}</strong> 
                                                    <a href="{if $shipping_extra_step == 1}{route key='basketStep3'}{else}{route key='basket'}{/if}">({translate key="Change payment method" fallback="change"})</a>
                                                </span>
                                            </li>
                                ...
                                <form method="post" action="{route key='basketStep3'}">
                                    ...
                                    {plugin module=shop template=basket-additional-order-confirmation}
                                </form>
                        </div>
                    </div>
