                    ...
                    <div class="box" id="box_register">
                        <form action="{route key='register'}"  method="post" enctype="multipart/form-data" novalidate>
                            <fieldset>
                                ...
                                <h3>
                                    <img src="{baseDir}/public/images/1px.gif" alt="" class="px1" >{translate key="Rejestracja B2B"}</span>
                                </h3>
                                    ...
                                    {if 'full' == $mode}
                                        ...
                                        <div class="mx-radioHide">
                                            ...
                                            <span class="input">
                                                ...
                                                <span class="radio-wrap">
                                                    <input type="radio" class="mx-choose" name="address_type" value="2" id="address_type2"{if 2 == (int) $address_type} checked="checked"{/if}>
