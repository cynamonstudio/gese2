{if count($related_products) && 1 == $skin_settings->productdetails->related}
    <div class="box row tab" id="box_productrelated" tabindex="-1">
                        ...
                        <div class="f-row">
                            ...
                            <div>
                                ...
                                <div class="f-grid-6 rwd-hide-medium">
                                    ...
                                    <div class="js__prodcut-short-desc description resetcss fr-view row">{$rproduct->translation->short_description}</div>
                                </div>
                                            ...
                                            {if $enablebasket && $rproduct->canBuyStock()}
                                                <fieldset>
                                                    {if !$rproduct->isBundle()}
                                                        <button class="addtobasket btn btn-red" type="submit" aria-label="{if $loyalty_exchange}{translate key="Exchange"}{else}{translate key="Add to cart"}{/if} {$rproduct->translation->name|escape}">
                                                            <img src="{baseDir}/libraries/images/1px.gif" alt="" class="px1" />
