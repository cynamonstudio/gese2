                                                ...
                                                {if $price_mode == '1' || $price_mode == '2'}
                                                    ...
                                                    {/if}
                                                        {if $product->specialOffer}
                                                            <em class="color">
                                                                {if $user_logged}
                                                                    {currency value=$product->defaultStock->getSpecialOfferPrice(true)}
                                                                {else}
                                                                    {currency value=$product->defaultStock->getSpecialOfferPrice()}
                                                                {/if}
                                                            </em>
                                                            <del>
                                                                {if $user_logged}
                                                                    {currency value=$product->defaultStock->getPrice(true)}
                                                                {else}
                                    ...
                                    {if $price_mode == '1' || $price_mode == '2'}
                                        ...
                                        {/if}
                                            {if $product->specialOffer}
                                                ...
                                                {if $product->currency and $currency->getIdentifier() != $product->currency->getIdentifier()}
                                                    <em class="default-currency">({currency id=$product->product->currency_id rate=1 value=$product->defaultStock->getCurrencySpecialOfferPrice(true)})</em>
                                                {/if} ({currency value=$product->defaultStock->getSpecialOfferPrice(false)} brutto)
                                            {else}
                                                <em>
                                                	{if $user_logged}
                                                        {currency value=$product->defaultStock->getPrice(true)}
                                                ...
                                                {/if}
                                                {if $user_logged}
                                                	({currency value=$product->defaultStock->getPrice(false)} brutto)
                                                {/if}
                                            {/if}
                                        {if $price_mode == '1'}
                                            )</i>
