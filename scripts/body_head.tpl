...
<div class="wrap rwd">
            ...
            {dynamic}
                <div class="login-bar row container">
                    <ul class="links right inline">
                    		<li class="telefon">{translate key="TELEFON"} ☎: <a  href="tel:570440673">+48 570 440 673</a></li>
    ...
    {/if}
<div class="modal modal-visible mx_mod-addtobasket-container mx-add">
    <div class="modal-header">
        <h3>Produkty zostały dodane do koszyka</h3>
        <div class="modal-close">
        <span class="modal-close-txt">zamknij</span>
        </div>
    </div>
    <div class="modal-footer">
        <div class="ajax-product-block">
            <a class="btn left">Kontynuuj zakupy</a><a class="btn btn-red right">Złóż zamówienie</a>
        </div>
    </div>
</div>
<div class="modal modal-visible mx_mod-addtobasket-container mx-error">
    <div class="modal-header">
        <h3>Błąd przy składaniu zamówienia</h3>
        <div class="modal-close">
        <span class="modal-close-txt">zamknij</span>
        </div>
    </div>
    <div class="modal-body">Nie można zamówić więcej sztuk niż jest dostępne na magazynie.</div>
</div>