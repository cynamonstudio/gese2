...
<form data-product-view-type="{$view|escape}" data-search-promotions-route="{route key="promotions"}" data-base-dir="{baseDir}" class="js__search search search-form" action="{route key='search'}" method="post">
    ...
    <div class="search-input search__input-area r--l-flex r--l-flex-vcenter">
        <div class="search__input-area-item">
            ...
            <img class="search__loader none" src="{baseDir}/libraries/images/loader.svg" alt="">
        </div>
        ...
        <div class="search__input-area-item search__input-area-item_grow">
            <input
                ...
                aria-label="{translate key='Search in store'}"
        ...
        <div class="search__input-area-item">
            ...
            <button
                type="button"
                class="js__search-submit-btn search-btn search__input-area-item btn btn-red search__btn-search r--l-flex r--l-flex-vcenter r--l-flex-hcenter"
                aria-label="{translate key='Search'}"
            >
    ...
    <div class="search__content" role="listbox" aria-label="Search results"></div>
