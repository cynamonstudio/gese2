...
<script type="text/javascript">
    {dynamic}
        ...
        Shop.iziIsSandbox = '{$inpostPayWidgetSettings.isSandbox}';
        {if $inpostPayWidgetSettings.isEnabled}
            Shop.mappedShippingMethodsIds = {$inpostPayWidgetSettings.mappedShippingMethodsId|@json_encode};
            Shop.inpostMerchantClientId = '{$inpostPayWidgetSettings.merchantClientId}';
        {/if}
        Shop.isSsoActive = '{if $isSsoActive}1{else}0{/if}';
	{/dynamic}
</script>
