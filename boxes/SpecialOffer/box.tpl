                                        ...
                                        {if $price_mode != '3'}
                                            ...
                                            {/if}
                                                {if $special_product->specialOffer}
                                                    <del>
                                                    	{if $user_logged}
                                                            {currency value=$special_product->defaultStock->getPrice(true)}
                                                        {else}
                                                            {currency value=$special_product->defaultStock->getPrice()}
                                                        {/if}
                                                    </del>    
                                                    <em class="color">
                                                        {if $user_logged}
                                                            {currency value=$special_product->defaultStock->getSpecialOfferPrice(true)}
                                                        {else}
                                                            {currency value=$special_product->defaultStock->getSpecialOfferPrice()}
                                                        {/if}
                                                    </em>
                                                    {if $special_product->currency and $currency->getIdentifier() != $special_product->currency->getIdentifier()}
